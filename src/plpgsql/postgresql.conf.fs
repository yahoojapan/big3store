...
hba_file = '/home/ubuntu/big3store/src/plpgsql/pg_hba.conf'	# host-based authentication file
					# (change requires restart)
...
#shared_buffers = 64GB			# min 128kB (x1e.2xlarge)
#shared_buffers = 2GB			# min 128kB ([it][23].large)
#shared_buffers = 1GB			# min 128kB (t[23].medium)
#shared_buffers = 512MB			# min 128kB (t[23].small)
shared_buffers = 256MB			# min 128kB (t[23].micro)
					# (change requires restart)
...
#checkpoint_flush_after = 1GB		# measured in pages, 0 disables
